...
/**
 * This is the item provider adapter for a {@link org.nasdanika.config.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider extends ValueConfigurationItemItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigPackage.Literals.SERVICE__SERVICE_TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Service.class)) {
			case ConfigPackage.SERVICE__SERVICE_TYPE:
