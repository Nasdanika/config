...
/**
 * This is the item provider adapter for a {@link org.nasdanika.config.NamedConfigurationItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedConfigurationItemItemProvider extends ConfigurationItemItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigPackage.Literals.NAMED_CONFIGURATION_ITEM__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NamedConfigurationItem.class)) {
			case ConfigPackage.NAMED_CONFIGURATION_ITEM__NAME:
